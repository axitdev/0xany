            ...
            <div class="bg-white dark:bg-zinc-700 rounded-lg shadow p-6">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="logo-upload-edit" class="flex flex-col items-center justify-center w-full h-32 border-2 border-zinc-200 border-dashed rounded-lg cursor-pointer bg-zinc-50 dark:hover:bg-zinc-700 dark:bg-zinc-600 hover:bg-gray-100 dark:border-zinc-500 dark:hover:border-zinc-400">
                            @if ($logo)
